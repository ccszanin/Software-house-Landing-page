  ...
  return (
    <body className="">
      ...
      <main className=" w-full max-w-screen-2xl px-20  flex flex-col justify-center items-center">
        ...
        <section
          id="section-3"
          className="w-full max-w-screen-2xl  flex flex-col justify-center"
        >
          <h1 className="font-extrabold uppercase text-[2.813rem] leading-[130%]  pt-20  ">
            Soluções
          </h1>
        ...
        >
          <h1 className="font-extrabold uppercase text-[2.813rem]  leading-[130%]  pb-[12.5rem]">
            Depoimentos
          </h1>
